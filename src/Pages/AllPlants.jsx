        ...
        <div className='sm:w-11/12 w-full mx-auto my-10'>
            ...
            <div className=''>
                <table className='w-full border border-gray-300 '>
                    <thead className='poppins text-white bg-blue-700'>
                        <tr className=''>
                    ...
                    <tbody className='text-center'>
                        {
                            plants.length>0 ? (
                                plants.map((plant,index)=><tr  className={index % 2 === 0 ? "bg-gray-200" : "bg-white"}>
                                    ...
                                    <td className='border border-gray-300'>{plant.name}</td>
                                    <td className='border border-gray-300'>{plant.category}</td>
                                    <td className='border border-gray-300'>{plant.watering_frequency}</td>
                                    <td className=' border border-gray-300 '><Link className='btn btn-sm hover:btn-secondary flex items-center gap-2 mx-auto w-[80%]'><IoMdEye className='hidden sm:flex' size={20}/>Details</Link></td>
                                </tr>)
                            ) : (
                              ""
                            )
